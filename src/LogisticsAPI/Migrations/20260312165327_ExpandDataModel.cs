        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    PropertyCode = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    Name = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    Address = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    PropertyType = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    BaseNightlyRate = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ManagementFeePercentage = table.Column<decimal>(type: "decimal(5,2)", nullable: false),
                    TenantId = table.Column<int>(type: "INTEGER", nullable: false),
                    PropertyOwnerId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WarehouseZone = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ConfirmationCode = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    ...
                    AccommodationRevenue = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    ManagementFeeAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    OwnerNetEarnings = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BookingSource = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    TenantId = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Timestamp = table.Column<DateTime>(type: "TEXT", nullable: false),
                    TenantId = table.Column<int>(type: "INTEGER", nullable: false),
                    MovementReasonCode = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyOwners_TenantId",
